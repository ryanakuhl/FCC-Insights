# -*- coding: utf-8 -*-
"""
Created on Fri Apr  6 15:56:22 2018
@author: ryan-kuhl
"""
import datetime
import feedparser
...
def email(symbol, address, current_price, company_name, message):
    ...
    smtpObj.ehlo()
    smtpObj.starttls()
    smtpObj.login('adamthemormon@gmail.com', '13131414')
    print(smtpObj.sendmail('adamthemormon@gmail.com',\
                     'ryanakuhl@gmail.com; Chad.laskey@gmail.com; anomonis66@gmail.com; eminemjones@gmail.com; Clayton1985@msn.com',\
                     'Subject: ' + ' | SEC F4 FILING: (' + str(tradingSymbol) + ')'+  str(company_name) + '.\n ' +
    ...
    for a in soup.find_all('a'):
        if a.getText()[-4:] == '.xml':
            ...
            #and ticker not in portfolio:
                ...
                if confirm(text=message, title='Insider Buy!', buttons=['OK', 'No share']) == 'OK':
                    SLACK_TOKEN = "xoxb-302721967973-UnxJzmSClCy8AsYykqkiJ6xy"
                    sc = SlackClient(SLACK_TOKEN)
                    sc.api_call("chat.postMessage", channel='#general', text=message, username='The GAINZ!')
